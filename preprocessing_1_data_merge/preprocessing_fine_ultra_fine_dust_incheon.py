...
# 2. 권역 수정
fine_dust = fine_dust[fine_dust['권역'].isin(['북부'])]
ultra_fine_dust = ultra_fine_dust[ultra_fine_dust['권역'].isin(['북부'])]

fine_dust['권역'] = '인천'
ultra_fine_dust['권역'] = '인천'
...
expanded_fine_dust.to_csv('modified_data/수정된_미세먼지_정보(인천).csv', index=False)
expanded_ultra_fine_dust.to_csv('modified_data/수정된_초미세먼지_정보(인천).csv', index=False)
