...
def addDirtyData():
    ...
    result_df = pd.concat([df, dirty_df])
...
# final test
detectDirtyData(pd.read_csv('merged_data/modified_merged_data.csv'))   # the number of dirty data before add

addDirtyData()
detectDirtyData(pd.read_csv('merged_data/data_after_add_dirtydata.csv'))   # the number of dirty data after add

removeDirtyData()
detectDirtyData(pd.read_csv('merged_data/data_after_remove_dirtydata.csv'))   # the number of dirty data after delete
