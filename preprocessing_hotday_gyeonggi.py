...
# 폭염일수 데이터 읽기
file_path = '/Users/leejuwon/Desktop/이주원/학교/3-1/데이터과학/DataScience/origin_data/2023_경기(수원)_폭염일수.csv'
hot_days = pd.read_csv(file_path, encoding='CP949')

# '지점명'을 '행정구역'으로 바꾸고 모든 값을 '경기'으로 통일
hot_days['행정구역'] = '경기'
...
# 변경된 데이터 저장
output_path = '/Users/leejuwon/Desktop/이주원/학교/3-1/데이터과학/DataScience/modified_data/2023_경기(수원)_폭염일수_modified.csv'
